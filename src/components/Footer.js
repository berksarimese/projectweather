    ...
    <div>
        ...
        <div className="container-fluid bblury">
          <footer className="d-flex flex-wrap justify-content-between align-items-center mx-3">
            <p className="col-md-4 mb-0 text-black-50">&copy; 2023 berksarimese</p>
            ...
            <ul className="nav col-md-4 justify-content-end ">
              ...
              <li className="nav-item"><a href="https://github.com/berksarimese" className="nav-link px-2 text-black-50">GitHub cc</a></li>
